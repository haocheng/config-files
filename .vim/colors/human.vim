...
" License:      GPL
"
" This is a modified "zenburn" (amazing colour scheme) that I made to match
" the Ubuntu Human colour theme to some extent. Okay, I was bored.
"
" zenburn, in turn
" Owes heavily to other Vim color files! With special mentions
" to "BlackDust", "Camo" and "Desert".
"
" To install, copy to ~/.vim/colors directory. Then :colorscheme ubuntu.  
...
"   
"      let g:ubuntu_alternate_Visual = 1
" 
" * To use alternate colouring for Error message, use
"     
"      let g:ubuntu_alternate_Error = 1
"
" * The new default for Include is a duller orang.e To use the original
"   colouring for Include, use
"     
"      let g:ubuntu_alternate_Include = 1
"
...
hi ErrorMsg        guifg=#60b48a guibg=#88522E gui=bold
...
hi Normal          guifg=#dcdccc guibg=#88522E
...
hi Statement       guifg=#e3ceab guibg=#88522E gui=none
...
hi Title           guifg=#efefef guibg=#88522E gui=bold
hi Todo            guifg=#7faf8f guibg=#88522E gui=bold
hi Typedef         guifg=#dfe4cf gui=bold
hi Type            guifg=#dfdfbf gui=bold
hi Underlined      guifg=#dcdccc guibg=#88522E gui=underline
hi VertSplit       guifg=#303030 guibg=#688060
hi VisualNOS       guifg=#333333 guibg=#f18c96 gui=bold,underline
hi WarningMsg      guifg=#ffffff guibg=#333333 gui=bold
hi WildMenu        guibg=#2c302d guifg=#cbecd0 gui=underline

if exists("g:ubuntu_alternate_Visual")
...
if exists("g:ubuntu_alternate_Error")
...
if exists("g:ubuntu_alternate_Include")
    " original setting
